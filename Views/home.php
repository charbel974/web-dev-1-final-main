  ...
  <div id="container" class="clear">
   ...
   <div id="pxs_container" class="pxs_container">
			<div class="pxs_slider_wrapper">
				<ul class="pxs_slider">
					<li><img src="/images/slideshow/im1.jpg" alt="First Image" /></li>
					<li><img src="/images/slideshow/im2.jpg" alt="Second Image" /></li>
					<li><img src="images/slideshow/im3.jpg" alt="Third Image" /></li>
					<li><img src="images/slideshow/im4.jpg" alt="Forth Image" /></li>
					<li><img src="images/slideshow/im5.jpg" alt="Fifth Image" /></li>
					<li><img src="images/slideshow/im6.jpg" alt="Sixth Image" /></li>
				</ul>
				...
				<ul class="pxs_thumbnails">
					<li><img src="images/slideshow/thumbs/1.jpg" alt="First Image" /></li>
					<li><img src="images/slideshow/thumbs/2.jpg" alt="Second Image" /></li>
					<li><img src="images/slideshow/thumbs/3.jpg" alt="Third Image" /></li>
					<li><img src="images/slideshow/thumbs/4.jpg" alt="Forth Image" /></li>
					<li><img src="images/slideshow/thumbs/5.jpg" alt="Fifth Image" /></li>
					<li><img src="images/slideshow/thumbs/6.jpg" alt="Sixth Image" /></li>
				</ul>
			</div>
		</div>
    </section>
    ...
    <div id="homepage">
      ...
      <section id="services" class="clear">
        <article class="one_third">
          ...
          <figure><img src="images/fashion_2014.jpg" alt="" width="290" height="290" id="Image">
            <figcaption>
        ...
        <article class="one_third">
          <figure><img src="images/fashion_2016.jpg" width="290" height="280" alt="">
            <figcaption>
        ...
        <article class="one_third lastbox">
          <figure><img src="images/fashion_men1.jpg" width="290" height="290" alt="">
            <figcaption>
